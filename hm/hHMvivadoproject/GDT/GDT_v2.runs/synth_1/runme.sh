...
HD_PWD='C:/Users/aleit/VivadoProj/GDT_v2/GDT_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GDT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GDT.tcl
