...
HD_PWD='/home/rijo/Downloads/Timer/hHM/hHM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timer32b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timer32b.tcl
