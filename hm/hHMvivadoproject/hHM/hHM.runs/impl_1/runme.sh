...
HD_PWD='/home/rijo/Downloads/Timer/hHM/hHM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timer32b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timer32b.tcl -notrace
